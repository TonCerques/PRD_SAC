...
$pdo->query("UPDATE PRD_ATENDIMENTO SET STATUS_ATEND = 'EXPIRADO' WHERE STATUS_ATEND = 'ABERTO' AND VALIDADE_ATEND < (CURRENT_TIMESTAMP AT TIME ZONE 'America/Sao_Paulo')");
