...
CREATE TABLE PRD_ATENDIMENTO(
    ...
    PROTOCOLO VARCHAR(15) DEFAULT 'XXXXX.000.000-0',
...
INSERT INTO TAB_CLIENTE(NOME_CLIENTE, CPF_CLIENTE, DATA_NASCIMENTO)
VALUES
...
INSERT INTO TAB_SERVICOS(ID_SERV, TIPO_SERV, PRECO_SERVICO)
VALUES
(1,'VALIDAÇÃO', 0),
(2, 'CONFERENCIA', 170.0),
(3,'BIOMETRIA_DIGITAL', 260.0);

INSERT INTO TAB_ITENS_SERV(VALIDACAO, CONFERENCIA, BIOMETRIA_DIGITAL, ID_FK_SERVICO)
VALUES
...
INSERT INTO TAB_FUNCIONARIO(NOME_FUNC, MATRICULA, DATA_NASCIMENTO)
VALUES 
...
INSERT INTO PRD_ATENDIMENTO(STATUS_ATEND, VALIDADE_ATEND, MOTIVO_ATEND, FEEDBACK, PROTOCOLO, TEMPO_ATEND, ID_FK_CLIENTE, ID_FK_FUNC)
VALUES 
...
INSERT INTO TAB_ITENS_ATEND (MOTIVO_PADRAO, RESPOSTA_PADRAO, ID_FK_SERV, ID_FK_ITEM_SERV) VALUES
